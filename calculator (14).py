...
entry = tk.Entry(window, font=("Arial", 30), bg="black", fg="white", justify="right")
entry.pack(fill="both", expand=True, padx=20, pady=20, ipadx=20, ipady=20)
...
for button in buttons: # Loop through the list of buttons
    b = tk.Button(button_frame, text=button, font=("Arial", 30), bg="blue", fg="white") # Create a button
